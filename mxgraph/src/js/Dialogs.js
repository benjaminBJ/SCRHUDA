...
var AboutDialog = function (editorUi) {
  ...
  mxUtils.write(h3, mxResources.get("about") + " SCRHUDA");
  div.appendChild(h3);
  ...
  mxUtils.br(div);
  mxUtils.write(div, "Powered by Convergence Engine ");
  mxUtils.br(div); 
  mxUtils.br(div);
  mxUtils.br(div);
 ...
 * Constructs a new edit file dialog.
 */
var EditHUDialog = function (editorUi) {
  var div = document.createElement("div");
  div.style.textAlign = "right";
  var textarea = document.createElement("textarea");
  textarea.setAttribute("wrap", "off");
...
var LayersWindow = function (editorUi, x, y, w, h) {
  ...
  listDiv.style.backgroundColor =
    Dialog.backdropColor == "white" ? "#dcdcdc" : "#e5e5e5";
  ...
  function refresh() {
    ...
    insertLink.setAttribute(
      "title",
      mxResources.get("moveSelectionTo", [label])
    );
