                    ...
                    if (!entity && handle != mxEvent.LABEL_HANDLE) {
                      ...
                      if (
                        ...
                        if (handle == null) {
                          ...
                          box.grow(
                            mxEdgeHandler.prototype.handleImage.width / 2
                          );
...
Graph.prototype.decompress = function (data) {
  if (data == null || data.length == 0 || typeof pako === "undefined") {
    ...
    return this.zapGremlins(
      decodeURIComponent(this.bytesToString(pako.inflateRaw(tmp)))
    );
  }
};
...
HoverIcons.prototype.click = function (state, dir, me) {
  ...
  if (
    ...
    var cells = this.graph.connectVertex(
      state.cell,
      dir,
...
HoverIcons.prototype.repaint = function () {
  ...
  if (this.currentState != null) {
    ...
    if (
      ...
      this.arrowUp.style.left =
        Math.round(
          this.currentState.getCenterX() -
            this.triangleUp.width / 2 -
            this.tolerance
        ) + "px";
      this.arrowUp.style.top =
        Math.round(bds.y - this.triangleUp.height - this.tolerance) + "px";
      mxUtils.setOpacity(this.arrowUp, this.inactiveOpacity);

      this.arrowRight.style.left =
        Math.round(bds.x + bds.width - this.tolerance) + "px";
      this.arrowRight.style.top =
        Math.round(
      ...
      this.arrowDown.style.top =
        Math.round(bds.y + bds.height - this.tolerance) + "px";
      mxUtils.setOpacity(this.arrowDown, this.inactiveOpacity);

      this.arrowLeft.style.left =
        Math.round(bds.x - this.triangleLeft.width - this.tolerance) + "px";
      ...
      if (this.checkCollisions) {
        ...
        var checkCollision = mxUtils.bind(this, function (cell, arrow) {
          ...
          if (
            ...
            (geo == null ||
              currentGeo == null ||
              (geo.height < 6 * currentGeo.height &&
...
(function () {
  ...
  mxStencil.prototype.evaluateTextAttribute = function (
    node,
    attribute,
    shape
  ) {
  ...
  (function () {
    ...
    Graph.prototype.getAllConnectionConstraints = function (terminal, source) {
      if (terminal != null) {
        var constraints =
          terminal.shape != null
            ? terminal.shape.getConstraints(terminal.style)
            : null;
    ...
    Graph.prototype.isValidDropTarget = function (cell) {
      ...
      return (
        mxUtils.getValue(style, "part", "0") != "1" &&
    ...
    Graph.prototype.isExtendParentsOnAdd = function (cell) {
      var result = mxGraph.prototype.isExtendParentsOnAdd.apply(
        this,
        arguments
      );
    ...
    Graph.prototype.getPreferredSizeForCell = function (cell) {
      var result = mxGraph.prototype.getPreferredSizeForCell.apply(
        this,
        arguments
      );
    ...
    Graph.prototype.addText = function (x, y, state) {
      ...
      if (state != null) {
        label.style +=
          "align=center;verticalAlign=middle;labelBackgroundColor=#ffffff;fillColor=none;";
    ...
    mxCellEditor.prototype.toggleViewMode = function () {
      ...
      if (!this.codeViewMode) {
        ...
        var content = mxUtils.extractTextWithWhitespace(
    ...
    mxCellEditor.prototype.getBackgroundColor = function (state) {
      ...
      if (
        ...
        this.graph
          .getModel()
          .isEdge(this.graph.getModel().getParent(state.cell))
      ) {
    ...
    mxVertexHandler.prototype.updateHint = function (me) {
      if (this.index != mxEvent.LABEL_HANDLE) {
        ...
        if (this.index == mxEvent.ROTATION_HANDLE) {
          ...
          this.hint.innerHTML =
            this.roundLength(this.bounds.width / s) +
            " x " +
    ...
    HoverIcons.prototype.rotationHandle = new mxImage(
      mxClient.IS_SVG
    ...
    mxEdgeHandler.prototype.labelHandleImage =
      HoverIcons.prototype.secondaryHandle;
    ...
    mxVertexHandler.prototype.redrawHandles = function () {
      ...
      if (this.state != null && this.linkHint != null) {
        ...
        this.linkHint.style.top =
          Math.round(
            b + this.verticalOffset / 2 + 6 + this.state.view.graph.tolerance
          ) + "px";
      }
    };
