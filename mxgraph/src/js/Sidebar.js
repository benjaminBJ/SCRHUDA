...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', 'Rectangle', null, null, 'rect rectangle box','fillcolor=none'),
	...
	this.addPaletteFunctions('general', mxResources.get('general'), expand || false, fns);
};
...
Sidebar.prototype.addHUPallete = function(expand)
{
	 ...
	 // Reusable cells
	 var field = new mxCell('+ field: type', new mxGeometry(0, 0, 200, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 field.vertex = true;
	 ...
	 var fns = [
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU N°1</b>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 1', null, null, 'historia de usuario'),
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU N°2</b>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 2', null, null, 'historia de usuario'),
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU N°3</b>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 3', null, null, 'historia de usuario'),
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU N°4</b>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 4', null, null, 'historia de usuario'),
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU N°5</b>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 5', null, null, 'historia de usuario'),
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU N°6</b>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 6',null, null, 'historia de usuario'),
 ...
 */
 Sidebar.prototype.addHUMiniPallete = function(expand)
 {
	  ...
	  var fns = [
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 40, 25, '<b>HU1</b>', 'Historia 1', null, null, 'historia de usuario'),
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 40, 25, '<b>HU2</b>', 'Historia 2', null, null, 'historia de usuario'),
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 40, 25, '<b>HU3</b>', 'Historia 3', null, null, 'historia de usuario'),
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 40, 25, '<b>HU4</b>', 'Historia 4', null, null, 'historia de usuario'),
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 40, 25, '<b>HU5</b>', 'Historia 5', null, null, 'historia de usuario'),
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 40, 25, '<b>HU6</b>', 'Historia 6', null, null, 'historia de usuario'),
		 this.createVertexTemplateEntry('shape=square;whiteSpace=wrap;html=1;size=14;verticalAlign=center;align=center;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=16', 45, 25, '<b>HU22</b>', 'Historia 10', null, null, 'historia de usuario'),
	 ];
...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	var fns = [
		...
		this.addEntry('uml activity state start', function()
		{
			...
			var edge = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#000000;fontColor=#000000');
			/*
		...
		{
			var cell = new mxCell('Actividad', new mxGeometry(0, 0, 120, 40),
		...
		{
	    	var cell = new mxCell('', new mxGeometry(0, 0, 200, 10), 'shape=line;html=1;strokeWidth=6;strokeColor=#000000;fontSize=13');
	    	cell.vertex = true;
			
			var edge = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#000000;fontSize=13');
			...
			return sb.createVertexTemplateFromCells([cell, edge], 200, 80, 'Bifurcar/Unir');
		}),
		this.addEntry('uml activity fork joinV', function()
		{
	    	var cell = new mxCell('', new mxGeometry(0, 0, 200, 10), 'shape=line;html=1;horizontal=0;strokeWidth=6;strokeColor=#000000;fontSize=13');
	    	cell.vertex = true;
		...
		this.createVertexTemplateEntry('ellipse;html=1;shape=endState;fillColor=#000000;strokeColor=#ff0000;', 30, 30, '', 'Fin', null, null, 'uml activity state end'),

		this.createVertexTemplateEntry('swimlane;html=1;horizontal=0;verticalAlign=top;strokeColor=#000000;fontSize=13;startSize=20;whiteSpace=wrap;fillColor=none;dashed=1', 520, 400, 'Piscina ', 'Piscina Horizontal', null, null, 'piscina'),
		this.createVertexTemplateEntry('swimlane;html=1;horizontal=0;verticalAlign=top;strokeColor=#000000;fontSize=13;swimlaneLine=0;whiteSpace=wrap;fillColor=none;dashed=1', 500, 200, 'Carril', 'Carril Horizontal', null, null, 'carril'),
		this.createVertexTemplateEntry('swimlane;html=1;horizontal=1;verticalAlign=top;strokeColor=#000000;fontSize=13;startSize=20;whiteSpace=wrap;fillColor=none;dashed=1', 400, 520, 'Piscina ', 'Piscina Vertical', null, null, 'piscina'),
		this.createVertexTemplateEntry('swimlane;html=1;horizontal=1;verticalAlign=top;strokeColor=#000000;fontSize=13;swimlaneLine=0;whiteSpace=wrap;fillColor=none;dashed=1', 200, 500, 'Carril', 'Carril Vertical', null, null, 'carril'),

	];
	
	this.addPaletteFunctions('uml', 'Diagrama de actividades', expand || false, fns);
};
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	[
	 	...
	 	this.createVertexTemplateEntry('shape=ext;rounded=1;html=1;whiteSpace=wrap;strokeWidth=3;', 120, 80, 'Call Actividad', 'Call Actividad', null, null, 'bpmn call activity'),
		...
		this.createVertexTemplateEntry('rounded=1;arcSize=10;dashed=1;strokeColor=#000000;fillColor=none;gradientColor=none;dashPattern=8 3 1 3;strokeWidth=2;',
	 	...
	 	this.createEdgeTemplateEntry('startArrow=diamondThin;startFill=0;startSize=14;endArrow=block;endFill=1;endSize=6;html=1;', 100, 0, '', 'Condiciónal Flow', null, 'bpmn conditional flow'),
