...
Sidebar.prototype.addHUPallete = function(expand)
{
	 ...
	 var fns = [
		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;fillColor=#fffca3;strokeColor=#000000;fontColor=#000000;fontSize=13', 200,100, '<b>HU</b> <i>NÚMERO</i>: <i>TÍTULO</i>\n\n<b>Como</b>  <i>ROL</i> \n <b>quiero</b>  <i>ACCION</i>\n<b>para</b>  <i>OBJETIVO</i>', 'Historia 1', null, null, 'historia de usuario'),
		...
		*/
		this.addEntry('uml activity state start', function()
		{
	    	var cell = new mxCell('', new mxGeometry(0, 0, 30, 30),
	    		'ellipse;html=1;shape=startState;fillColor=#000000;strokeColor=#000000;');
	    	cell.vertex = true;
		...
		{
			var cell = new mxCell('Composición', new mxGeometry(0, 0, 160, 60),
					'swimlane;html=1;fontStyle=1;align=center;verticalAlign=middle;childLayout=stackLayout;horizontal=1;startSize=30;horizontalStack=0;resizeParent=0;resizeLast=1;container=0;fontColor=#000000;collapsible=0;rounded=1;arcSize=30;strokeColor=#000000;fillColor=#ffffff;swimlaneFillColor=#ffffff;fontSize=13');
			cell.vertex = true;
